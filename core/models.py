...
class SiteSettings(models.Model):
    ...
    collect_personal_data = models.BooleanField(
        "Собирать контакты посетителя", default=True,
    ...
    landing_title = models.CharField(
        "Заголовок стартовой страницы", max_length=255,
    ...
    result_title = models.CharField(
        "Заголовок страницы результата", max_length=255,
    ...
    footer_text = models.CharField(
        "Текст в подвале страниц", max_length=255,
